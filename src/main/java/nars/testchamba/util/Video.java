...
//    }
    ...
    public static float hashFloat(final int h) {
        return (h) / (((float) Integer.MAX_VALUE) - ((float) Integer.MIN_VALUE));
    }

    @Deprecated
    public static Color getColor(final String s, final float saturation, final float brightness) {
        return getColor(s.hashCode(), saturation, brightness);
    }

    @Deprecated
    public static Color getColor(int hashCode, float saturation, float brightness) {
    ...
    public static int getColor(final String s, float sat, float bright, float alpha) {
    ...
    public static void init() {
        ...
        */
        ...
        System.setProperty("java.version", "1.8.666"); //so it works on jdk9
