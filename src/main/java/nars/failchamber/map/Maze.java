...
import nars.failchamber.object.Geometric;
import nars.failchamber.state.Cell;
import nars.failchamber.state.Hauto;
import nars.failchamber.state.Hauto.SetMaterial;

import static nars.failchamber.state.Cell.Material.StoneWall;
import static nars.failchamber.state.Hauto.irand;
