...
public interface CollisionListener {
     ...
     */
    boolean beforeStartingCollision(@NotNull Body bodyA, @NotNull Body bodyB);
     ...
     */
    boolean beforeResolvingCollision(@NotNull CollisionInfo collisionInfo);
     ...
     * @param collisionInfo collision information
     */
    void afterResolvingCollision(@NotNull CollisionInfo collisionInfo);
}
