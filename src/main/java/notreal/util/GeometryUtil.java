...
public final class GeometryUtil {
    ...
    public static boolean isPointInsideConvexPolygon(
            @NotNull Point2D point, @NotNull Point2D[] polygonVertexes, double epsilon) {
    ...
    public static boolean isPointInsideConvexPolygon(@NotNull Point2D point, @NotNull Point2D[] polygonVertexes) {
    ...
    public static boolean isPointOutsideConvexPolygon(@NotNull Point2D point, @NotNull Point2D[] polygonVertexes) {
