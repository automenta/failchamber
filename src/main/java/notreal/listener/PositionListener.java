...
public interface PositionListener {
     ...
     */
    boolean beforeChangePosition(@NotNull Point2D oldPosition, @NotNull Point2D newPosition);
     ...
     */
    void afterChangePosition(@NotNull Point2D oldPosition, @NotNull Point2D newPosition);
}
